...
# BS=16; deepspeed run_clm_better_transformer.py \


BS=16
GAS=$((256/$BS))
OUTPUT_DIR="checkpoints-mistral-300M"

python run_clm_better_transformer.py \
    --model_type "gpt2" \
    --config_name "gpt2-medium" \
    --tokenizer_name ../tokenizer/spm_tokenizer_neologdn_bytefallback_nofast \
    --train_file ../dataset/wiki_mrph_for_spm.txt \
